...
import com.justdoit.elementlibrary.http.BaseUrl;
import com.justdoit.elementlibrary.http.GlobalHttpHandler;
import com.justdoit.elementlibrary.http.log.DefaultFormatPrinter;
import com.justdoit.elementlibrary.http.log.FormatPrinter;
import com.justdoit.elementlibrary.http.log.RequestInterceptor;
import com.justdoit.elementlibrary.imageloader.loader.GlideLoader;
...
public class GlobalConfigModule {
    ...
    @Singleton
    @Provides
    ILoader provideImageLoader() {
        return mImageLoader == null ? new GlideLoader() : mImageLoader;
    }
    ...
    public static final class Builder {
        ...
        public Builder imageLoader(ILoader loader) {
